# Utopia Reworked
Modded version of carykh's food chain simulator, which he demonstrated in his YouTube video! https://www.youtube.com/watch?v=Zy9N48udcdc
Original Project: https://github.com/carykh/Utopia

# How to run this project
Download Utopia-main from this project page
Extract all from the zipped file

Go to this link: https://processing.org/download
This will take you to Processing's official download page. Download the most recent version.

Once you have finished downloading Processing, open it and then click on "File" -> "Open..."
It will prompt you to select a Processing sketch (or a PDE file).
Click on the unzipped file (or Utopia-main) and then click on Utopia.pde

Once you have opened the project file, click "Run" and you should be running the project!
...
**Stamina**
Similar to Speed but is a bit different. Higher stamina corresponds to lower speed output (-7%), but energy burn is up to 20% slower, and vice versa for lower stamina (+7% speed, +20% energy burn). A creature with high speed and low stamina can run very fast, however burn energy over 50% faster.

**Metabolism**
Metabolism is pretty complicated so ill just summarize it. Higher metabolism increases hunger and thrist growth rate (up to +20%), even when the creature isnt moving, (Note that when hunger or thrist growth is increased, the creature gains urgency to do that task quicker) aswell as the creatures speed (Speed goes up by up to 10%), since higher metabolism = faster processing, However, aging is quicker, so lifespan is up to -20% less. Its vice versa for lower metabolism.
...
# Update Log
**(1.1.c)**
-Added interbreeding, if no creature of the same species are near the creature, then the creature will mate with another similiar species instead. (92% chance for offspring to become one of their parent's species, 8% for a completely different species)
