...
Mutations have a 5% chance of appearing Higher fertile lands = Faster plant growth, however lower fertile lands = slow plant growth You can also play as the creatures, give it a try! (Except for the plants, but theres no reason to anyway) I also split the predator creature into 2 different species that eats one type of both cows. Cows and the predators can eat secondary foods that are not as appeasing to them, but they will prioritize primary foods first. I might add more biodiversity in the future. (3rd food chain path inbetween mountain and lowlands? Maybe!) (Omnivores? Prehaps!) (Apex predator? Prehaps!) Let me know what I should add!
