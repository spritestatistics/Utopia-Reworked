...
color[] SPECIES_COLORS = {
  ...
  color(0,0,0),   // 4: Orange Predator, deprecrated
  color(0,0,0),    // 5: Blue Predator, deprecrated
  color(34,185,34),   // 6: Green Cow
  color(225,0,0),     // 7: Red Carnivore
...
float[] PRIORITY_CAPS = {0.0,0.0,0.2,0.5,0.1,0.0};
...
float[][] PRIORITY_RATES = {
  {3.2,0,0,0,0,0},               // 0: Pink Flower
  {3.2,0,0,0,0,0},            // 1: Ice Flower
  {11.9, 4, 3.1, 0, 0, -75}, // 2: Yellow Cow
  {11.7, 3.9, 3, 0, 0, -75},     // 3: Teal Cow
  {0, 0, 0, 0, 0, 0},// 4: Orange Predator
  {0, 0, 0, 0, 0, 0},  // 5: Blue Predator
  {11.8, 3.95, 3.05, 0, 0, -75},// 6: Green Cow
  {12.3, 3.65, 2.9, 0, 0, -80},//7: red Predator
  {3,0,0,0,0,0}             // 8: Green Flower, green flowers are more likely to suceed so i made them grow slower to equalize it more
};
...
boolean[][] IS_FOOD = {
  ...
  {false, false, true,  true,  false, false, true,  false, false}, // 7: red predator
  {false, false, false, false, false, false, false, false, false}  // 8: Green Flower
};
float[] CALORIES_RATE = {1.2, 1.2, 1, 1, 0.8, 0.8, 1, 0.8, 1.2};
float[] SPECIES_SPEED = {0.0, 0.0, 0.521, 0.52, 0, 0, 0.5205, 0.54, 0.0}; // base speed, changed by creature stats
