...
float[][] PRIORITY_RATES = {
  {4,0,0,0,0,0},               // 0: Pink Flower
  {4,0,0,0,0,0},            // 1: Ice Flower
  {11.9, 4, 3.2, 0, 0, -75}, // 2: Yellow Cow
  {11.7, 3.9, 3.1, 0, 0, -75},     // 3: Teal Cow
  {11.6, 3.7, 2.9, 0, 0, -80},// 4: Orange Predator
  {11.4, 3.6, 2.8, 0, 0, -80},  // 5: Blue Predator
  {11.8, 3.95, 3.15, 0, 0, -75},// 6: Green Cow
  {11.5, 3.65, 2.85, 0, 0,-80},//7: Green Predator
  {4,0,0,0,0,0}             // 8: Green Flower, grows slightly faster than other flowers
};
...
float[] CALORIES_RATE = {1.25, 1.25, 1, 1, 0.8, 0.8, 1, 0.8, 1.25};
